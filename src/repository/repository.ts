...
import { IRepositoryItem, IRepositoryResource } from './repository.interfaces';

export class Repository<T extends IRepositoryItem>
  implements IRepositoryResource<T>
{
  private items: T[] = [];
